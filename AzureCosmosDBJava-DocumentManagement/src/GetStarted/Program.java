...
public class Program 
{
    ...
    private static final RequestOptions options = null;
    ...
    private void getStartedDemo() throws DocumentClientException, IOException 
    {
        ...
        this.client = new DocumentClient("https://samplecosmosdb0128.documents.azure.com:443/", "pjCHLiK1SxJ31PmluEOtPpT2S5KRYg6Ch2s8JeKvJQvhg9NXjq23ciFYWRNVfQaSsJRtn2UHdxZim8oyhD1Cbg==", new ConnectionPolicy(), ConsistencyLevel.Session);
       ...
       // this.client.deleteDatabase("/dbs/ExampleDB", null);
        ...
        this.deleteExampleDocument("ExampleDB", "ExampleCollection","JayaUsha International School");
    ...
    private void executeSimpleQuery(String databaseName, String collectionName) {
     ...
     // this.client.deleteCollection(collectionName, null)
    ...
    private void deleteExampleDocument(String databaseName, String collectionName, String documentName) throws IOException,
        ...
        try {           
            ...
            this.client.deleteDatabase(String.format("/dbs/%s", databaseName), null);
        	writeToConsoleAndPromptToContinue(String.format("Deleted School %s", documentName));
        	writeToConsoleAndPromptToContinue(String.format("Deleted Database %s", databaseName));
        } catch (DocumentClientException de) {
            throw de;
        }
    }
